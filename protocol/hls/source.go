...
import (
	...
	"github.com/push-stream-service/container/ts"
	"github.com/push-stream-service/parser"
...
func (source *Source) Write(p *av.Packet) (err error) {
	//fmt.Println("in fc func (source *Source) Write(p *av.Packet) (err error) {} in source.go")
	err = nil
	if source.closed {
