...
import (
	...
	"github.com/push-stream-service/protocol/api"
	"github.com/push-stream-service/protocol/hls"
	"github.com/push-stream-service/protocol/httpflv"
	"github.com/push-stream-service/protocol/rtmp"
...
func main() {
	...
	for _, app := range apps {
		...
		stream := rtmp.NewRtmpStream(hlsServer)
		//if app.Flv {
		//	startHTTPFlv(stream)
		//}
		if app.Api {
